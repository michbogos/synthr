...
enum NodeType{
    ...
    POLYGON=11,
    OUTPUT=12,
    ADD=13, SUBTRACT, MULTIPLY, NUMBER, FILTER_LOWPASS, FILTER_HIGHPASS,FILTER_BANDPASS, FILTER_NOTCH, FILTER_APF, FILTER_PEAKEQ , COMB_FILTER, ALLPASS_FILTER, DIVIDE, WHITE_NOISE, PINK_NOISE, BROWN_NOISE, DELAY, DISTORTION, BITCRUSHER, MIDI_CONTROL, REVERB, DIFFERENTIATE
};
