...
#include<envelope.h>
enum NodeType{
    ADSR, MIDI_GATE, MIDI_PITCH,  MODWHEEL, PITCHBEND, VELOCITY, WAVETABLE, TRIANGLE, SAW, SQUARE, SIN, POLYGON, OUTPUT, ADD, SUBTRACT, MULTIPLY, NUMBER, FILTER_LOWPASS, FILTER_HIGHPASS,FILTER_BANDPASS, FILTER_NOTCH, FILTER_APF, FILTER_PEAKEQ , COMB_FILTER, ALLPASS_FILTER, DIVIDE, WHITE_NOISE, PINK_NOISE, BROWN_NOISE, DELAY, DISTORTION, MIDI_CONTROL
};
